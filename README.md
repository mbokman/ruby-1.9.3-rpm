...
#### RHEL/CentOS 5/6
    ...
    yum install -y rpm-build rpmdevtools gcc glibc-devel readline-devel ncurses-devel gdbm-devel tcl-devel openssl-devel db4-devel byacc libyaml-devel libffi-devel make
    rpmdev-setuptree
    cd ~/rpmbuild/SOURCES
